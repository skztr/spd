...
execute if score #spd_global spd_depends_cool matches ..0 if score #spd_global spd_depends matches ..1 as @a unless score @s spd_depends = #spd_global spd_depends run function spd:depends/tell
